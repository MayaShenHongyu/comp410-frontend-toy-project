...
export type ConterAction = IncrementCountAction | DecrementCountAction | SetCountAction;
...
export const reducer: Reducer<CounterState> = (state: CounterState | undefined, action: ConterAction): CounterState => {
    if (state === undefined) {
        return { count: 0 };
    }
